...
import game.Views.CurrentLevel;
...
public class SetHiScore {
    private static final String CSV_PATH = RESOURCES.replace("file:", "") + "highscores/highscores";
    public ArrayList<HighScore> hList = new ArrayList<>();
    /**
